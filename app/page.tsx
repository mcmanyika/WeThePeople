          ...
          <section className="bg-slate-900 py-10 sm:py-14">
            <div className="mx-auto max-w-7xl px-4 sm:px-6">
              <div className="mb-6 text-center sm:mb-8">
                ...
                <p className="mt-2 text-sm text-slate-400">Moments captured from our events, campaigns, and community activities.</p>
              </div>
            </div>
              ...
              {galleryImages.map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-end">
                    {image.title && (
                      <p className="text-white text-xs font-medium px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 truncate w-full">
                        {image.title}
                      </p>
                    )}
                  </div>
